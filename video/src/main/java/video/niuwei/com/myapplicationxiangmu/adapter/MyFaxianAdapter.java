...
public class MyFaxianAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    private List<JBean.RetBean.ListBean.ChildListBean> list;
    private Context context;
    public MyFaxianAdapter(List<JBean.RetBean.ListBean.ChildListBean> childList, FragmentActivity activity) {
        this.list=childList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=View.inflate(context,R.layout.faxian_recy_layout,null);

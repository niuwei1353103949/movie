...
import video.niuwei.com.myapplicationxiangmu.tantan.CardAdapter;
import video.niuwei.com.myapplicationxiangmu.tantan.CardMode;
import video.niuwei.com.myapplicationxiangmu.tantan.SwipeFlingAdapterView;
...
public class Wode extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = View.inflate(getActivity(), R.layout.wode_layout, null);
        initView();
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<>(getActivity(), R.layout.item, R.id.helloText, al);
